        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                {{-- @foreach ($languages as $language)
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700 flex flex-col items-center">
                        <img src="{{ $language->image_url }}" alt="{{ $language->name }}" class="w-16 h-16 rounded-full mb-4">
                        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">{{ $language->name }}</h2>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">
                            Quizzes disponíveis: <span class="font-semibold">{{ $language->quiz_count }}</span>
                        </p>
                    </div>
                @endforeach --}}
            </div>
